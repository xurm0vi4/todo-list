...
export function SmallCheckIcon() {
  return (
...
export function MoveIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
      <path d="M7.22 1.22a.75.75 0 011.06 0l2.25 2.25a.75.75 0 010 1.06L8.28 6.78a.75.75 0 01-1.06-1.06l.97-.97H3.75a.75.75 0 010-1.5h4.44l-.97-.97a.75.75 0 010-1.06zM8.78 14.78a.75.75 0 01-1.06 0l-2.25-2.25a.75.75 0 010-1.06l2.25-2.25a.75.75 0 111.06 1.06l-.97.97h4.44a.75.75 0 010 1.5H7.81l.97.97a.75.75 0 010 1.06z" />
    </svg>
  )
}
